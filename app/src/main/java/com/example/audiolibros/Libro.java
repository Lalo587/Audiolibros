...
public class Libro {
    ...
    public final static String G_S_XIX="Literatura del siglo XIX";
    public final static String G_SUSPENSE="Suspense";
    public static final String[] G_ARRAY = new String[]{G_TODOS, G_EPICO,G_S_XIX,G_SUSPENSE};
    ...
    public static Vector<Libro> ejemploLibros(){
        ...
        libros.add(new Libro("Kappa","Akutawa",R.drawable.kappa,SERVIDOR+"kappa.mp3",
